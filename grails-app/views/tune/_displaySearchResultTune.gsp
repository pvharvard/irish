<tr>
    ...
    <g:elseif test="${abcOption.equals('First Bars Music')}">
        <th class="hidden-xs"><pre>X:1<br/>${raw(tune.version1KeyMeter)}${raw(tune.version1KeyMeter)}${raw(tune.version1StartAbc)}</pre></th>
    </g:elseif>
    <g:elseif test="${abcOption.equals('Full ABC')}">
        <th class="hidden-xs">${raw(tune.version1Abc)}</th>
    </g:elseif>
    <g:elseif test="${abcOption.equals('Full Music')}">
        <th class="hidden-xs"><pre>X:1<br/>${raw(tune.version1KeyMeter)}${raw(tune.version1KeyMeter)}${raw(tune.version1Abc)}</pre></th>
    </g:elseif>
