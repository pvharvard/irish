...
<html>
    ...
    <body>
        ...
        <div id="show-version" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.version}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.version}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
